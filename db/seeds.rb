...
movies = [
  ...
  {"title"=>"War Horse", "year"=>2011, "overview"=>"Follows a young man named Albert and his horse, Joey, and how their bond is broken when Joey is sold to the cavalry and sent to the trenches of World War One. Despite being too young to enlist, Albert heads to France to save his friend.", "start_year"=>1912, "end_year"=>1918, "lat"=>50.8576482083408, "lng"=>-3.61865758371835}
]
